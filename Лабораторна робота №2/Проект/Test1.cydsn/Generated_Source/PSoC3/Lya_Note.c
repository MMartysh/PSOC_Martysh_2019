...
void Lya_Note_Start(void) 
{
    ...
    Lya_Note_CLKEN |= Lya_Note_CLKEN_MASK;
	Lya_Note_CLKSTBY |= Lya_Note_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Lya_Note_Stop
********************************************************************************
*
* Summary:
...
void Lya_Note_Stop(void) 
{
    ...
    Lya_Note_CLKEN &= (uint8)(~Lya_Note_CLKEN_MASK);
	Lya_Note_CLKSTBY &= (uint8)(~Lya_Note_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Lya_Note_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((Lya_Note_CLKEN & Lya_Note_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = Lya_Note_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Lya_Note_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* Lya_Note__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(Lya_Note_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Lya_Note_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Lya_Note_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Lya_Note_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = Lya_Note_GetSourceRegister();
    uint16 oldDivider = Lya_Note_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Lya_Note_CLKEN & Lya_Note_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Lya_Note_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: Lya_Note_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(Lya_Note_DIV_PTR);
}


/*******************************************************************************
* Function Name: Lya_Note_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    Lya_Note_MOD_SRC |= modeBitMask & (uint8)Lya_Note_MODE_MASK;
}


/*******************************************************************************
* Function Name: Lya_Note_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    Lya_Note_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Lya_Note_MODE_MASK));
}


/*******************************************************************************
* Function Name: Lya_Note_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return Lya_Note_MOD_SRC & (uint8)(Lya_Note_MODE_MASK);
}


/*******************************************************************************
* Function Name: Lya_Note_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = Lya_Note_GetDividerRegister();
    uint8 oldSrc = Lya_Note_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Lya_Note_MOD_SRC |= CYCLK_SSS;
        Lya_Note_MOD_SRC =
            (Lya_Note_MOD_SRC & (uint8)(~Lya_Note_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Lya_Note_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return Lya_Note_MOD_SRC & Lya_Note_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Lya_Note_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    Lya_Note_PHASE = clkPhase & Lya_Note_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Lya_Note_GetPhase
********************************************************************************
*
* Summary:
...
{
    return Lya_Note_PHASE & Lya_Note_PHASE_MASK;
}
