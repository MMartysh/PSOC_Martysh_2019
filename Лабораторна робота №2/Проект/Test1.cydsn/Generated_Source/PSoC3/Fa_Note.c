...
*
*******************************************************************************/
void Fa_Note_Start(void) 
{
    /* Set the bit to enable the clock. */
    Fa_Note_CLKEN |= Fa_Note_CLKEN_MASK;
	Fa_Note_CLKSTBY |= Fa_Note_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Fa_Note_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Fa_Note_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    Fa_Note_CLKEN &= (uint8)(~Fa_Note_CLKEN_MASK);
	Fa_Note_CLKSTBY &= (uint8)(~Fa_Note_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Fa_Note_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Fa_Note_StopBlock(void) 
{
    if ((Fa_Note_CLKEN & Fa_Note_CLKEN_MASK) != 0u)
    {
...
#if defined(Fa_Note__CFG3)
        CLK_DIST_AMASK = Fa_Note_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Fa_Note_CLKEN_MASK;
        ...
        oldDivider = CY_GET_REG16(Fa_Note_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Fa_Note_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Fa_Note_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Fa_Note_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        Fa_Note_CLKSTBY &= (uint8)(~Fa_Note_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: Fa_Note_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Fa_Note_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = Fa_Note_GetSourceRegister();
    uint16 oldDivider = Fa_Note_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Fa_Note_CLKEN & Fa_Note_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Fa_Note_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: Fa_Note_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 Fa_Note_GetDividerRegister(void) 
{
    return CY_GET_REG16(Fa_Note_DIV_PTR);
}


/*******************************************************************************
* Function Name: Fa_Note_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Fa_Note_SetModeRegister(uint8 modeBitMask) 
{
    Fa_Note_MOD_SRC |= modeBitMask & (uint8)Fa_Note_MODE_MASK;
}


/*******************************************************************************
* Function Name: Fa_Note_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Fa_Note_ClearModeRegister(uint8 modeBitMask) 
{
    Fa_Note_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Fa_Note_MODE_MASK));
}


/*******************************************************************************
* Function Name: Fa_Note_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Fa_Note_GetModeRegister(void) 
{
    return Fa_Note_MOD_SRC & (uint8)(Fa_Note_MODE_MASK);
}


/*******************************************************************************
* Function Name: Fa_Note_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Fa_Note_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = Fa_Note_GetDividerRegister();
    uint8 oldSrc = Fa_Note_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Fa_Note_MOD_SRC |= CYCLK_SSS;
        Fa_Note_MOD_SRC =
            (Fa_Note_MOD_SRC & (uint8)(~Fa_Note_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Fa_Note_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Fa_Note_GetSourceRegister(void) 
{
    return Fa_Note_MOD_SRC & Fa_Note_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Fa_Note_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Fa_Note_SetPhaseRegister(uint8 clkPhase) 
{
    Fa_Note_PHASE = clkPhase & Fa_Note_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Fa_Note_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Fa_Note_GetPhaseRegister(void) 
{
    return Fa_Note_PHASE & Fa_Note_PHASE_MASK;
}
