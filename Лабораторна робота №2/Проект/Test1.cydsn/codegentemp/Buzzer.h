...
*/
     ...
     */
        /* Drive Modes */
        #define Buzzer_DM_ALG_HIZ         PIN_DM_ALG_HIZ   /**< \brief High Impedance Analog   */
        #define Buzzer_DM_DIG_HIZ         PIN_DM_DIG_HIZ   /**< \brief High Impedance Digital  */
        #define Buzzer_DM_RES_UP          PIN_DM_RES_UP    /**< \brief Resistive Pull Up       */
        #define Buzzer_DM_RES_DWN         PIN_DM_RES_DWN   /**< \brief Resistive Pull Down     */
        #define Buzzer_DM_OD_LO           PIN_DM_OD_LO     /**< \brief Open Drain, Drives Low  */
        #define Buzzer_DM_OD_HI           PIN_DM_OD_HI     /**< \brief Open Drain, Drives High */
        #define Buzzer_DM_STRONG          PIN_DM_STRONG    /**< \brief Strong Drive            */
        #define Buzzer_DM_RES_UPDWN       PIN_DM_RES_UPDWN /**< \brief Resistive Pull Up/Down  */
    /** @} driveMode */
/** @} group_constants */
...
*/
     ...
     */
        ...
        #define Buzzer_INTR_RISING    (uint16)(0x0001u)   /**< \brief Rising edge trigger  */
        #define Buzzer_INTR_FALLING   (uint16)(0x0002u)   /**< \brief Falling edge trigger */
        #define Buzzer_INTR_BOTH      (uint16)(0x0003u)   /**< \brief Both edge trigger    */
        /** @} intrMode */
/** @} group_constants */
